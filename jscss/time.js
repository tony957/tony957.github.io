function showTime() { 
	...
	var startDate = new Date(2018, 07, 17);
	var date3 = currentDate-startDate;
	var days=Math.floor(date3/(24*3600*1000));
	var leave1=date3%(24*3600*1000);     //计算天数后剩余的毫秒数
	var hours=Math.floor(leave1/(3600*1000))+1;
	var leave2=leave1%(3600*1000)+40;        //计算小时数后剩余的毫秒数
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear xmm:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----张礼达   2018-08-17</c>"; 
